...
@interface TMAddBookView () <UICollectionViewDelegate, UICollectionViewDataSource>

@property (nonatomic, strong) NSArray *bookImageFiles;
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section {
    ...
    return self.bookImageFiles.count;
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *imageFileName = self.bookImageFiles[indexPath.row];
...
- (void)clickedSureBtn:(UIButton *)sender {
    ...
    NSString *bookImageFileName = self.bookImageFiles[self.previousSelectedIndexPath.row];
