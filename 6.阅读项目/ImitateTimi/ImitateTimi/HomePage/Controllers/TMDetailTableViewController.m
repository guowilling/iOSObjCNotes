...
@interface TMDetailTableViewController () <UITableViewDataSource, UITableViewDelegate>
...
- (NSArray *)allBills {
    ...
    if (!_allBills) {
        ...
        _allBills = [NSArray accordingToDateStrSortArray:mutableArray ascending:NO];
    }
    return _allBills;
}
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[TMDetailViewCell class] forCellReuseIdentifier:detailViewCellID];
    ...
    [backBtn setTitleColor:kEditBtnTitleColor forState:UIControlStateNormal];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TMDetailViewCell *cell = [tableView dequeueReusableCellWithIdentifier:detailViewCellID forIndexPath:indexPath];
