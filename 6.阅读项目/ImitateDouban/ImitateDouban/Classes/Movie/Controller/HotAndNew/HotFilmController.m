...
@interface HotFilmController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation HotFilmController
...
- (void)loadNewData {
    ...
    __weak HotFilmController *weakSelf = self;
    [MovieHttpTool getHotMovieWithStart:0 arrayBlock:^(NSMutableArray *array) {
        _filmDatas = array;
...
- (void)loadMoreData {
    ...
    __weak HotFilmController *weakSelf = self;
    [MovieHttpTool getHotMovieWithStart:_filmDatas.count arrayBlock:^(NSMutableArray *array) {
