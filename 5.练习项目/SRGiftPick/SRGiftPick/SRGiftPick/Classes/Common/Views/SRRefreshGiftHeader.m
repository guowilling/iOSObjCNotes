...
@implementation SRRefreshGiftHeader
...
- (void)prepare {
    ...
    UIImage *image2 = [UIGraphicsGetImageFromCurrentImageContext() imageByScalingToSize:CGSizeMake(40, 40)];
    [startImages addObject:image2];
    UIGraphicsEndImageContext();
